...
{
    options.UseSqlServer(builder.Configuration.GetConnectionString("DbContextConStr"));
});
...
builder.AddAppSwaggerGen(); // added in extension method

builder.AddAppAuthetication();// added in extension method
